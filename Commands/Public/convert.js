	...
	if(args.length==3 && args[0] && !isNaN(args[0]) && args[1] && args[2]) {
		try {
			...
			try {
				...
				msg.channel.createMessage(`${msg.author.mention} I don't support that unit, please try something else. You can use standard currency codes or any of these: <https://github.com/ben-ng/convert-units#supported-units>`);
			}
		}
	} else {
